...
// SCRAPPED: Multiple views on a single hash call was discouraged. I also failed to repopulate the STATE long and lat from the location.hash. Perhaps if I had more time but I am pressed as is.
...
var interpretHash = function() {
	currentHash = (location.hash.substring(1)).split("/")
	STATE.lat = currentHash[0]
	STATE.long = currentHash[1]
	STATE.view = currentHash[2]
}
